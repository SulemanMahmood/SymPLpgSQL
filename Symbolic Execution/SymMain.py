...
DB.execute("commit")
DB.execute("Select proname, proargtypes, prorettype from pg_proc p where p.oid not in (select t.tgfoid from pg_trigger t) and prolang = 11899 and proname = 'simplecase';")
